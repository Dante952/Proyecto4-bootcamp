...
public class CustomerController {
    ...
    @PatchMapping("{ruc}")
    public ResponseEntity<Mono<Customer>> update(@PathVariable("ruc") final String dni,@Valid @RequestBody CustomerUpdateDto customerUpdateDto){
        try{
    ...
    @DeleteMapping("{ruc}")
    public Mono delete(@PathVariable("ruc") final String ruc){

        return customerService.delete(ruc);
    }

    @GetMapping("{ruc}")
    public Mono<Customer> findByDni(@PathVariable("ruc") final String ruc){
